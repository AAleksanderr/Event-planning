    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventModels", x => x.EventModelId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventDetail_EventModels_EventModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EventUserRegistrationId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventUserRegistration_EventModels_EventModelId",
                        column: x => x.EventModelId,
                        principalTable: "EventModels",
                        principalColumn: "EventModelId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventDetail_EventModelId",
                table: "EventDetail",
                column: "EventModelId");

            migrationBuilder.CreateIndex(
                name: "IX_EventUserRegistration_EventModelId",
